...
const AddContractType = ({ contract_typeId, onCancel, onSuccess }) => {
  ...
  useEffect(() => {
    ...
    const fetchMaxSTT = async () => {
      ...
      try {
        const allContract_Types = await fetchDataList('https://dx.hoangphucthanh.vn:3000/maintenance/contract-types');
    ...
    const onFinish = async (values) => {
      ...
      try {
        ...
        const response = await createItem('https://dx.hoangphucthanh.vn:3000/maintenance/contract-types', payload);
