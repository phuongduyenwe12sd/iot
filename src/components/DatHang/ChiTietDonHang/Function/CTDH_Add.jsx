...
const AddOrderDetail = ({ onCancel, onSuccess }) => {
  ...
  useEffect(() => {
    ...
    fetchAndSetList('https://dx.hoangphucthanh.vn:3000/maintenance/contracts', setContracts, 'Không thể tải danh sách hợp đồng').finally(() => setFetchLoading(false));
    fetchAndSetList('https://dx.hoangphucthanh.vn:3000/maintenance/orders', setOrders, 'Không thể tải danh sách đơn hàng').finally(() => setFetchLoading(false));
  ...
  const onFinish = async (values) => {
        ...
        try {
          ...
          const response = await createItem('https://dx.hoangphucthanh.vn:3000/maintenance/order-details', payload);
