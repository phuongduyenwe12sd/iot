...
import { validateData, getFieldLabel } from '../../utils/import/validationHelpers';
...
const NhaCungCap_Import = ({ open, onClose, onSuccess }) => {
  ...
  const handleValidateData = (data) => {
    return validateData(data, requiredFields, (field) => getFieldLabel(field, columnMapping), setErrorItems);
  };
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        const altResponse = await createItem('https://dx.hoangphucthanh.vn:3000/maintenance/suppliers', dataToImport);
  ...
  const handleDownloadTemplate = () => {
    ...
    const sampleData = [
      ...
      ['NCC002', 'Công ty XYZ', '0987654321', 'contact@xyz.com', '456 Đường XYZ, Quận 2, TP.HCM', 
       'Việt Nam', '9876543210', 'www.xyz.com', '1000000', 'Nhà cung cấp mẫu 2']
    ];
